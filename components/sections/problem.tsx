      ...
      <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
        <MotionReveal>
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg text-neutral-600">
            Group chats sprawl, scores fade by Monday, and nobody carries a reputation that travels
            from park to park. Trust and memory never get a real home.
          </p>
          <p className="mx-auto mt-4 max-w-xl text-base text-neutral-600">{brand.pitchTrust}</p>
        </MotionReveal>

        <MotionReveal className="mt-16 w-full max-w-lg" delay={0.1}>
          <div className="rounded-3xl border border-neutral-200 bg-white p-8 shadow-sm">
            <div className="flex flex-col gap-3">
              {["Who is playing?", "Which court?", "What time?", "Is it full?", "What was the score last week?"].map(
                (line, i) => (
                  <div
                    key={line}
